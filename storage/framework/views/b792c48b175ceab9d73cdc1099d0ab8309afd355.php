...
<body>
    <div id="app">
               ...
               <!--  </div> -->
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                   ...
                   <a class="navbar-brand" href="<?php echo e(url('/home')); ?>">
                         <img src="<?php echo e(asset('/uploads/img_web/icon_cmu.png')); ?>" height="50" width="50" >
                   </a>
                    <a class="navbar-brand" href="<?php echo e(url('/public')); ?>">
                         <img src="<?php echo e(asset('/uploads/img_web/icon_pub.png')); ?>" height="50" width="50" >
                   </a>
                    </ul>
        ...
        <img src="<?php echo e(asset('/uploads/img_web/header.jpg')); ?>" width="100%" class="img-responsive" style="" />
        </div>
        </nav>
