...
<!--                 <a href="<?php echo e(url('/import_excel_view_general'.'&'.$off_id.'&'.$year)); ?>" class="btn">ข้อมูลทั่วไป</a>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <br>
                    <iframe name="each_pub_table_demo1" src="<?php echo e(url('/each_pub_table1&'.$off_id.'&'.$year)); ?>" width="100%" height="200" style="overflow: hidden; border: 0" scrolling="no"></iframe>
                    <br>
                    <center>
                    <p>
                    <!-- <a href="<?php echo e(url('/table1&'.$off_id.'&'.$year)); ?>" target="demo1">สรุปข้อมูลในปี<?php //echo $year; ?></a>&nbsp;&nbsp;&nbsp;     -->
                    </p>
                    </center>
                    <hr>
                <!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
                    <center>
                    <iframe name="each_pub_chart_demo1" src="<?php echo e(url('/each_pub_chart1&'.$off_id.'&'.$year)); ?>" width="50%" height="460" style="overflow: hidden; border: 0" scrolling="no"></iframe>
                    <br>
                    <p>
                    <a href="<?php echo e(url('/each_pub_chart1&'.$off_id.'&'.$year)); ?>" target="each_pub_chart_demo1">ปริมาณการใช้พลังงานไฟฟ้าปี <?php echo $year; ?></a>&nbsp;&nbsp;&nbsp;    
                    <a href="<?php echo e(url('/each_pub_chart2&'.$off_id.'&'.$year)); ?>" target="each_pub_chart_demo1">ค่าใช้จ่ายพลังงานไฟฟ้าปี <?php echo $year; ?></a>&nbsp;&nbsp;&nbsp;
                    <a href="<?php echo e(url('/each_pub_chart3&'.$off_id.'&'.$year)); ?>" target="each_pub_chart_demo1">ปริมาณการใช้พลังงานไฟฟ้าเปรียบเทียบปี <?php echo $year; ?></a>&nbsp;&nbsp;&nbsp;
                    </p>
                    </center>
                    <hr>
                <!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
                <br>
                    ...
                    <?php $__currentLoopData = DB::SELECT(DB::raw("SELECT * 
                                    ...
                                    WHERE off_id = $off_id AND year = $year order by building_name"));; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                ...
                <!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
                    <center>
                    <iframe name="each_pub_table_demo3" src="<?php echo e(url('/each_pub_table3&'.$off_id.'&'.$year)); ?>" width="50%" height="300" style="overflow: hidden; border: 0" scrolling="no"></iframe>
                    <br>
                    <p>
                    <a href="<?php echo e(url('/each_pub_table3&'.$off_id.'&'.$year)); ?>" target="each_pub_table_demo3">รวม</a>&nbsp;&nbsp;&nbsp;    
                    <a href="<?php echo e(url('/each_pub_table4&'.$off_id.'&'.$year)); ?>" target="each_pub_table_demo3">ตามอาคาร</a>&nbsp;&nbsp;&nbsp;
                    <a href="<?php echo e(url('/each_pub_table5&'.$off_id.'&'.$year)); ?>" target="each_pub_table_demo3">ตามมีเตอร์</a>&nbsp;&nbsp;&nbsp;
                ...
                <!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
                    <center>
                    <iframe name="each_pub_chart_demo2" src="<?php echo e(url('/chart4&'.$off_id.'&'.$year)); ?>" width="50%" height="450" style="overflow: hidden; border: 0" scrolling="no"></iframe>
                    <br>
                    <p>
                    <a href="<?php echo e(url('/each_pub_chart4&'.$off_id.'&'.$year)); ?>" target="each_pub_chart_demo2">รวม</a>&nbsp;&nbsp;&nbsp;    
                    <a href="<?php echo e(url('/each_pub_chart5&'.$off_id.'&'.$year)); ?>" target="each_pub_chart_demo2">ตามอาคาร</a>&nbsp;&nbsp;&nbsp;
                    <a href="<?php echo e(url('/each_pub_chart6&'.$off_id.'&'.$year)); ?>" target="each_pub_chart_demo2">ตามมีเตอร์</a>&nbsp;&nbsp;&nbsp;
                ...
                <!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
<!--                     <center>
                    <iframe name="chart_demo3" src="<?php echo e(url('/chart7&'.$off_id.'&'.$year)); ?>" width="50%" height="550" style="overflow: hidden; border: 0" scrolling="no"></iframe>
                    <br>
                    </center>
                    <hr> -->
                <!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
