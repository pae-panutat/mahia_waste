        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <!-- ========================================================= -->            
                ...
                <div class="panel-body">
                    ...
                    <center><h3>อัพโหลดExcel:ตารางระบบแสงสว่าง<h3><center>

                    <?php echo Form::open(array('route' => 'import_excel_elamp_t1','method'=>'POST','files'=>'true')); ?>
                ...
                <tr>
                <td align="left"> 
                    <a href="<?php echo e(url('/import_excel_del_elamp_t1'.'&'.$off_id.'&'.$year)); ?>" class="btn" style="background-color:#E74C3C; color:white;">ลบข้อมูลเพื่ออัพโหลดใหม่</a>

                </td>

                <td align="right"> 
                     
                    <a href="<?php echo e(url('/import_excel_view_elamp_t1'.'&'.$off_id.'&'.$year)); ?>" class="btn" style="background-color:#3498DB; color:white;">ตารางระบบแสงสว่าง</a>
                    <a href="<?php echo e(url('/import_excel_view_elamp_t2'.'&'.$off_id.'&'.$year)); ?>" class="btn" style="background-color:#3498DB; color:white;">ตารางสรุประบบแสงสว่าง</a>  
