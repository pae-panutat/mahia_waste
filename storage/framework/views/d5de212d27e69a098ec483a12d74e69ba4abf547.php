            ...
            <script type="text/javascript" src="js/jscharts.js"></script>
                <br>
                    ...
                    <br>
                        ...
                        <form action="<?php echo e(url('/table5&'.$off_id.'&'.$year)); ?>">
                          ...
                          <select name="meter" id="meter">
                            ...
                            <?php $__currentLoopData = DB::SELECT(DB::raw("SELECT id_meter 
                            ...
                            <option value="<?php echo e($data->id_meter); ?>"><?php echo "meter : ".$data->id_meter; ?></option>
