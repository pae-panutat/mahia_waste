        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <br>             
                ...
                <div class="panel-body">
                    ...
                    <?php echo Form::open(array('route' => 'import_excel_elamp_t2','method'=>'POST','files'=>'true')); ?>
                ...
                <tr>
                <td align="left"> 
                    <a href="<?php echo e(url('/import_excel_del_elamp_t2'.'&'.$off_id.'&'.$year)); ?>" class="btn" style="background-color:#E74C3C; color:white;">ลบข้อมูลเพื่ออัพโหลดใหม่</a>
