        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <!-- ========================================================= -->            
                ...
                <div class="panel-body">
                    ...
                    <?php echo Form::open(array('route' => 'import_excel_oil_t1b','method'=>'POST','files'=>'true')); ?>
                ...
                <tr>
                <td align="left"> 
                    <a href="<?php echo e(url('/import_excel_del_oil_t1b'.'&'.$off_id.'&'.$year)); ?>" class="btn" style="background-color:#E74C3C; color:white;">ลบข้อมูลเพื่ออัพโหลดใหม่</a>
                </td>
                ...
                <td align="right"> 
                    ...
                    <a href="<?php echo e(url('/export_file_oil_t1b'.'&'.$off_id.'&'.$year)); ?>" class="btn" style="background-color:#3CBC8D; color:white;">ExportCSV</a>             
                </td>
                </tr>
                <tr>
                <td  colspan="2">
