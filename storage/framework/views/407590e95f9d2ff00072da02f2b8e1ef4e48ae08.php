				...
				<aside class="app-sidebar">
                    ...
                    <?php else: ?>  
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                               <a class="side-menu__item"  href="<?php echo e(url('/alldatacmu')); ?>"><i class="side-menu__icon fa fa-desktop"></i><span class="side-menu__label">ภาพรวมทั้งมหาลัยฯ</span><i class="angle fa fa-angle-right"></i></a>
                               </li>
                            <?php endif; ?>
                           <li class="slide">
