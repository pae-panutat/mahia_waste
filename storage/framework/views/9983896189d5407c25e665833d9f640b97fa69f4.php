    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <!-- ========================================================= -->            
                ...
                <?php if(empty(DB::connection($db->db_name)->select("SELECT * FROM water_t1 WHERE off_id = $off_id AND year = $year"))): ?> 

                <div class="panel-body">

                    <center><h3>อัพโหลดExcel:ตารางระบบน้ำ<h3><center>

                    <?php echo Form::open(array('route' => 'import_excel_water_t1','method'=>'POST','files'=>'true')); ?>
                ...
                <tr>
                <td align="left"> 
                    <a href="<?php echo e(url('/import_excel_del_water_t1'.'&'.$off_id.'&'.$year)); ?>" class="btn" style="background-color:#E74C3C; color:white;">ลบข้อมูลเพื่ออัพโหลดใหม่</a>

                </td>

                <td align="right"> 
                     
                    <a href="<?php echo e(url('/import_excel_view_water_t1'.'&'.$off_id.'&'.$year)); ?>" class="btn" style="background-color:#3498DB; color:white;">ตารางระบบน้ำ</a>
                    <a href="<?php echo e(url('/export_file_water_t1'.'&'.$off_id.'&'.$year)); ?>" class="btn" style="background-color:#3CBC8D; color:white;">ExportCSV</a>             
                </td>
                </tr>
                <tr>
                <td  colspan="2">
                    ...
                    <table border="1" width="100%" > 
                        <tr>
                            <td colspan="25" style="background-color: #EAFAF1;"><center><h3>ข้อมูลน้ำ_t1</h3></center></td>
                        </tr>
                        <tr>
                            <td ><center>เดือน</center></td>
                            <td ><center>ปริมาณ<br>(ลูกบาศก์เมตร/เดือน)</center></td>
                            <td ><center>ค่าน้ำ<br>(บาท)</center></td>
                            <td ><center>ค่าน้ำเฉลี่ย<br>(บาท/ลูกบาศก์เมตร)</center></td>
                        ...
                        <tr>
                            ...
                            <td ><center><?php  echo $data->cost_avg_baht_per_meter; ?></center></td>
                        </tr> 
                        <?php $k=$k+1; ?>
