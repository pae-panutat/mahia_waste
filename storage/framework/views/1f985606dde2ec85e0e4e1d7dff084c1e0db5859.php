        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <!-- ========================================================= -->
                ...
                <div class="panel-body">
                    ...
                    <?php echo Form::open(array('route' => 'import_excel_airconditioner_t2','method'=>'POST','files'=>'true')); ?>
                ...
                <tr>
                <td align="left"> 
                    <a href="<?php echo e(url('/import_excel_del_airconditioner_t2'.'&'.$off_id.'&'.$year)); ?>" class="btn" style="background-color:#E74C3C; color:white;">ลบข้อมูลเพื่ออัพโหลดใหม่</a> 
                </td>

                <td align="right"> 
                    <a href="<?php echo e(url('/import_excel_view_airconditioner_t1'.'&'.$off_id.'&'.$year)); ?>" class="btn" style="background-color:#3498DB; color:white;">ตารางเครื่องปรับอากาศ</a>
                    <a href="<?php echo e(url('/import_excel_view_airconditioner_t2'.'&'.$off_id.'&'.$year)); ?>" class="btn" style="background-color:#3498DB; color:white;">ตารางสรุปเครื่องปรับอากาศ</a>
