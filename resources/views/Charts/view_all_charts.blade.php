...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            @endforeach
                <br>
                    <iframe name="table_demo1" src="{{url('/table1&'.$off_id.'&'.$year)}}" width="100%" height="200" style="overflow: hidden; border: 0" scrolling="no"></iframe>
                    <br>
                    <center>
                    <p>
                ...
                <!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
                    <center>
                    <iframe name="chart_demo1" src="{{url('/chart1&'.$off_id.'&'.$year)}}" width="50%" height="460" style="overflow: hidden; border: 0" scrolling="no"></iframe>
                    <br>
                    <p>
                    <a href="{{url('/chart1&'.$off_id.'&'.$year)}}" target="chart_demo1">ปริมาณการใช้พลังงานไฟฟ้าปี <?php echo $year; ?></a>&nbsp;&nbsp;&nbsp;    
                    <a href="{{url('/chart2&'.$off_id.'&'.$year)}}" target="chart_demo1">ค่าใช้จ่ายพลังงานไฟฟ้าปี <?php echo $year; ?></a>&nbsp;&nbsp;&nbsp;
                    <a href="{{url('/chart3&'.$off_id.'&'.$year)}}" target="chart_demo1">ปริมาณการใช้พลังงานไฟฟ้าเปรียบเทียบปี <?php echo $year; ?></a>&nbsp;&nbsp;&nbsp;
                    </p>
                    </center>
                    <hr>
                <!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
                ...
                <!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
                    <center>
                    <iframe name="table_demo3" src="{{url('/table3&'.$off_id.'&'.$year)}}" width="50%" height="300" style="overflow: hidden; border: 0" scrolling="no"></iframe>
                    <br>
                    <p>
                    <a href="{{url('/table3&'.$off_id.'&'.$year)}}" target="table_demo3">รวม</a>&nbsp;&nbsp;&nbsp;    
                    <a href="{{url('/table4&'.$off_id.'&'.$year)}}" target="table_demo3">ตามอาคาร</a>&nbsp;&nbsp;&nbsp;
                    <a href="{{url('/table5&'.$off_id.'&'.$year)}}" target="table_demo3">ตามมีเตอร์</a>&nbsp;&nbsp;&nbsp;
                ...
                <!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
                    <center>
                    <iframe name="chart_demo2" src="{{url('/chart4&'.$off_id.'&'.$year)}}" width="50%" height="450" style="overflow: hidden; border: 0" scrolling="no"></iframe>
                    <br>
                    <p>
                    <a href="{{url('/chart4&'.$off_id.'&'.$year)}}" target="chart_demo2">รวม</a>&nbsp;&nbsp;&nbsp;    
                    <a href="{{url('/chart5&'.$off_id.'&'.$year)}}" target="chart_demo2">ตามอาคาร</a>&nbsp;&nbsp;&nbsp;
                    <a href="{{url('/chart6&'.$off_id.'&'.$year)}}" target="chart_demo2">ตามมีเตอร์</a>&nbsp;&nbsp;&nbsp;
