        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <!-- ========================================================= -->            
                ...
                <td align="right"> 
                    ...
                    <a href="{{ url('/public_elamp_t1'.'&'.$off_id.'&'.$year) }}" class="btn" style="background-color:#3498DB; color:white;">ตารางระบบแสงสว่าง</a>
                    <a href="{{ url('/public_elamp_t2'.'&'.$off_id.'&'.$year) }}" class="btn" style="background-color:#3498DB; color:white;">ตารางสรุประบบแสงสว่าง</a>  
