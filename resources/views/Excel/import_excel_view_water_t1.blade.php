    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <!-- ========================================================= -->            
                ...
                @if(empty(DB::connection($db->db_name)->select("SELECT * FROM water_t1 WHERE off_id = $off_id AND year = $year"))) 

                <div class="panel-body">

                    <center><h3>อัพโหลดExcel:ตารางระบบน้ำ<h3><center>

                    {!! Form::open(array('route' => 'import_excel_water_t1','method'=>'POST','files'=>'true')) !!}
                ...
                <tr>
                <td align="left"> 
                    <a href="{{ url('/import_excel_del_water_t1'.'&'.$off_id.'&'.$year) }}" class="btn" style="background-color:#E74C3C; color:white;">ลบข้อมูลเพื่ออัพโหลดใหม่</a>

                </td>

                <td align="right"> 
                     
                    <a href="{{ url('/import_excel_view_water_t1'.'&'.$off_id.'&'.$year) }}" class="btn" style="background-color:#3498DB; color:white;">ตารางระบบน้ำ</a>
                    <a href="{{ url('/export_file_water_t1'.'&'.$off_id.'&'.$year) }}" class="btn" style="background-color:#3CBC8D; color:white;">ExportCSV</a>             
                </td>
                </tr>
                <tr>
                <td  colspan="2">
