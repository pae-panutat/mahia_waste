        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <!-- ========================================================= -->
                ...
                <div class="panel-body">
                    ...
                    <center><h3>อัพโหลดExcel:ตารางสรุปเครื่องใช้ไฟฟ้า<h3><center>

                    {!! Form::open(array('route' => 'import_excel_equipment_t2','method'=>'POST','files'=>'true')) !!}
                ...
                <tr>
                <td align="left"> 
                    <a href="{{ url('/import_excel_del_equipment_t2'.'&'.$off_id.'&'.$year) }}" class="btn" style="background-color:#E74C3C; color:white;">ลบข้อมูลเพื่ออัพโหลดใหม่</a> 
                </td>

                <td align="right">   
                    <a href="{{ url('/import_excel_view_equipment_t1'.'&'.$off_id.'&'.$year) }}" class="btn" style="background-color:#3498DB; color:white;">ตารางอุปกรณ์ไฟฟ้า</a>
                    <a href="{{ url('/import_excel_view_equipment_t2'.'&'.$off_id.'&'.$year) }}" class="btn" style="background-color:#3498DB; color:white;">ตารางสรุปอุปกรณ์ไฟฟ้า</a> 
                ...
                <td  colspan="2">
                    ...
                    <center>   
                    <form method="POST" action="{{ url('/import_excel_edit_equipment_t2'.'&'.$off_id.'&'.$year) }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
