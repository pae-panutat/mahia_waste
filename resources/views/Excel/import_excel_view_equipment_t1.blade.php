        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <!-- ========================================================= -->
                ...
                <div class="panel-body">
                    ...
                    {!! Form::open(array('route' => 'import_excel_equipment_t1','method'=>'POST','files'=>'true')) !!}
                ...
                <tr>
                <td align="left"> 
                    <a href="{{ url('/import_excel_del_equipment_t1'.'&'.$off_id.'&'.$year) }}" class="btn" style="background-color:#E74C3C; color:white;">ลบข้อมูลเพื่ออัพโหลดใหม่</a> 
                </td>
