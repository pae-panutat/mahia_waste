				...
				<aside class="app-sidebar">
                    ...
                    @else  
                        ...
                        <ul class="side-menu">
                            ...
                            {{-- <li class="slide">
                               <a class="side-menu__item" href="#"><i class="side-menu__icon fa fa-desktop"></i><span class="side-menu__label">ภาพรวมทั้งมหาลัยฯ</span></a>
                               </li>
                           --}}
                           <li class="slide">
                               <a class="side-menu__item"  href="{{ url('/home') }}"><i class="side-menu__icon fa fa-bar-chart"></i><span class="side-menu__label">หน้าหลัก</span></a>
                               {{-- <ul class="slide-menu">
