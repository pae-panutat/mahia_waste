...
class EachPubHomeController extends Controller
{
    /**
     ...
     */
//=================================================
        public function each_pub_indexDash()
    {
...
//=================================================
//=================================================
        public function each_pub_analyticChart()
    {


        //echo "now on analyticGraph controller";
        return view('each_pub_homeAnalyticChart');
    }
//=================================================
//=================================================
        public function each_pub_analyticDash()
    {
...
//=====================================
        ...
        return view('each_pub_homeAnalyticDash',['data' => $data]);
    }
//=================================================
//=================================================
        public function each_pub_analyticYear(Request $req)
    {
